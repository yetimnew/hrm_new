@extends( 'master.app' )
@section( 'title', 'TIMS | Job System Update' )
@section( 'content' )
    ...
    <div class="card text-left">
        ...
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h2>Downtime Update <strong class="blue">{{$jobsystem->name}}</strong></h2>
                @can('driver edit')
                <div class="ml-auto">
                    <a href="{{route('job_system.index')}}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            <form method="post" action="{{route('job_system.update',$jobsystem->id)}}" class="form-horizontal"
                id="driver_reg">
                @csrf
                @method('PATCH')
                @include('maintenance.job_system.form')
