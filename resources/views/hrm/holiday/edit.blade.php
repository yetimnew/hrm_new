                ...
                <div class="card text-left col-md-12">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4>Holiday Update <strong class="blue">{{$holiday->name}}</strong></h4>
                            {{-- @can('driver edit') --}}
                            <div class="ml-auto">
                                <a href="{{route('holiday.index')}}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('holiday.update',$holiday->id)}}" class="form-horizontal"
