                ...
                <div class="card text-left col-md-12">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                <a href="{{route('holiday.create')}}" class="btn btn-outline-primary btn-sm"><i
                            ...
                            <table class="table-sm table table-bordered table-sm table-striped" id="personales">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="m-1 b-1">Date</th>
                                        <th class="m-1 b-1">Recurring</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <input type="hidden" class="deleted_value_id" value="{{$holiday->id}}">
                                        <td class='p-1'>{{++$no}}</td>
                                        <td class='p-1'>{{$holiday->description}}</td>
                                        <td class='p-1'>{{$holiday->date}}</td>
                                        <td class='p-1'>{{$holiday->recurring}}</td>


                                        {{-- @can('driver edit') --}}
                                        <td class='p-1 text-center' data-toggle="tooltip" data-placement="top"
                                            title="edit">
                                            <a href="{{route('holiday.edit', $holiday->id)}}"><i
    ...
    var deleted_id = $(this).closest("tr").find('.deleted_value_id').val();
        ...
        swal({
            ...
            if (willDelete) {
                ...
                var urlPath = '/hrm/holiday/'+ deleted_id;
                // alert(urlPath);
