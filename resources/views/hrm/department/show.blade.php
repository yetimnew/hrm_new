                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <form method="post" action="{{route('personale.activate',$personale->id)}}"
                            ...
                            @method('POST')
                            <div class="ml-auto">
                                <button type="submit" class="btn btn-el btn-outline-primary ml-auto" name="save"><i
                    ...
                    <div class='col-4 ml-1 p-1'>
                        <a href="{{route('personale.deactivate',$personale->id)}}"
                            class="btn btn-el btn-outline-primary ml-auto"> <i class="fa fa-edit"></i> Deactivate </a>
                    </div>
