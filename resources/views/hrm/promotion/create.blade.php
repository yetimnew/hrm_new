    ...
    <div class="card text-left">
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                <h2>promotion Registration</h2>
                {{-- <!-- @can('driver create') --> --}}
                <div class="ml-auto">
                    <a href="{{route('promotion.index')}}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('promotion.store')}}" class="form-horizontal" id="driver_reg"
                novalidate>
                @csrf
                @include('hrm.promotion.form')
