                ...
                <div class="card text-left col-md-12">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                <a href="{{route('pay_grade.create')}}" class="btn btn-outline-primary btn-sm"><i
                                        class="fas fa-plus mr-1"></i>Add pay_grade</a>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table-sm table table-bordered table-sm table-striped" id="personales">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <input type="hidden" class="deleted_value_id" value="{{$pay_grade->id}}">
                                        <td class='p-1'>{{++$no}}</td>
                                        <td class='p-1'>{{$pay_grade->name}}</td>
                                        <td class='p-1'>{{$pay_grade->comment}}</td>


                                        {{-- @can('driver edit') --}}
                                        <td class='p-1 text-center' data-toggle="tooltip" data-placement="top"
                                            title="edit">
                                            <a href="{{route('pay_grade.edit', $pay_grade->id)}}"><i
                                                    class="fas fa-edit"></i></a>
                                        </td>
                                        <td class='p-1 text-center' data-toggle="tooltip" data-placement="top"
                                            title="delete">
                                            <button id="delete_pay_grade" class="delete_pay_grade red"> <i
...
<script type="application/javascript">
    $( document ).ready( function () {
            ...
            $('.delete_pay_grade').click(function (e) {
    ...
    var deleted_id = $(this).closest("tr").find('.deleted_value_id').val();
        ...
        swal({
            ...
            if (willDelete) {
                ...
                var urlPath = '/hrm/pay_grade/'+ deleted_id;
                // alert(urlPath);
