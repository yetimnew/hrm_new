                ...
                <div class="card text-left col-md-12">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4>Personale Update <strong class="blue">{{$pay_grade->name}}</strong></h4>
                            {{-- @can('driver edit') --}}
                            <div class="ml-auto">
                                <a href="{{route('pay_grade.index')}}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('pay_grade.update',$pay_grade->id)}}"
                            class="form-horizontal" id="driver_reg" novalidate>
                            @csrf
                            @method('PATCH')
                            @include('hrm.pay_grade.form')
