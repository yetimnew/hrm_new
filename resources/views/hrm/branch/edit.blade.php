                ...
                <div class="card text-left col-md-12">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4>Personale Update <strong class="blue">{{$branch->name}}</strong></h4>
                            {{-- @can('driver edit') --}}
                            <div class="ml-auto">
                                <a href="{{route('branch.index')}}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('branch.update',$branch->id)}}" class="form-horizontal"
                            id="driver_reg" novalidate>
                            @csrf
                            @method('PATCH')
                            @include('hrm.branch.form')
