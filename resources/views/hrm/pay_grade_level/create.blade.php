    ...
    <div class="card text-left">
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                <h2>pay_grade_level Registration</h2>
                {{-- <!-- @can('driver create') --> --}}
                <div class="ml-auto">
                    <a href="{{route('pay_grade_level.index')}}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            <form method="post" action="{{route('pay_grade_level.store')}}" class="form-horizontal" id="driver_reg"
                novalidate>
                @csrf
