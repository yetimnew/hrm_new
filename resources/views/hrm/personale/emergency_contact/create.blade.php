...
<div class="col-md-12">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Employee Emergency Contact Registration</li>
        </ol>
    </nav>
    <div class="card text-left">
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                <h4>Employee Emergency Contact Registration</h4>
                {{-- <!-- @can('driver create') --> --}}
                <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('emergence_contact.store')}}" class="form-horizontal" id="driver_reg">
                @csrf
                {{-- @method('HEAD') --}}
