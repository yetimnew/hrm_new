    ...
    <div class="card text-left">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h2>Personale Update <strong class="blue">{{$education->employer}}</strong></h2>
                {{-- @can('driver edit') --}}
                <div class="ml-auto">
                    <a href="{{route('personale.show',$education->personale_id)}}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            <form method="post" action="{{route('education.update',$education->id)}}" class="form-horizontal"
