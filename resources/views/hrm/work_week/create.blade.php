...
<div class="col-md-12">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Holiday Registration</li>
        </ol>
    </nav>
    <div class="card text-left">
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- <!-- @can('driver create') --> --}}
                <div class="ml-auto">
                    <a href="{{route('holiday.index')}}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('holiday.store')}}" class="form-horizontal" id="driver_reg" novalidate>
                @csrf
                @include('hrm.holiday.form')
