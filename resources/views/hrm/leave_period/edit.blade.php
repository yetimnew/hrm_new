                ...
                <div class="card text-left col-md-12">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4>Personale Update <strong class="blue">{{$leave_period->name}}</strong></h4>
                            {{-- @can('driver edit') --}}
                            <div class="ml-auto">
                                <a href="{{route('leave_period.index')}}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('leave_period.update',$leave_period->id)}}" class="form-horizontal"
